...
puremvc.define(
    ...
    startup: function() {
      if (!this.initialized) {
        ...
        this.registerCommand(
          counter.AppConstants.STARTUP,
          counter.controller.command.StartupCommand
        );
        // issue the SETUP notification to execute StartupCommand
        this.sendNotification(counter.AppConstants.STARTUP);
      }
    }
  },
  ...
  // STATIC MEMBERS
  {
    ...
    getInstance: function(multitonKey) {
      ...
      return (instanceMap[multitonKey] = new demo.ApplicationFacade(
        multitonKey
      ));
    },
